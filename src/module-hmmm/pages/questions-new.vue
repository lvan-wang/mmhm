  ...
  <div class="container">
    ...
    <el-card>
          ...
          <div v-if="id === '0' || id === ':id'">
            ...
            <div v-if="form.questionType === '1'">
              <el-radio-group v-model="optionsNum">
                <div
                  class="block"
                  v-for="(item, index) in optionCheckbox"
                  :key="index"
                >
                  ...
                  >
                    ...
                    <el-button v-else class="onpicBtn"
                      >上传图片
              ...
              >
                <el-radio-group v-model="checkboxItem">
                  <div class="block">
                    ...
                    <el-input v-model="item.title"></el-input>
                    <el-button class="onpicBtn" @click="$refs.inputFile.click()"
                      >上传图片<i class="el-icon-circle-close icon_close"></i
                    ></el-button>
                  </div>
                </el-radio-group>
              </div>
      ...
      <el-button
        ...
        >确认提交</el-button
      >
      <el-button v-else type="primary" class="footer" @click="editQuestion"
        >确认修改</el-button
      >
    </el-card>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      headerObj: {
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjUwMCwicmlkIjowLCJpYXQiOjE2MTY1ODIyMzQsImV4cCI6MTYxNjY2ODYzNH0.t3jGjqvaPhrG-BUEo2KI4rGQtfYA7vxz4r0vnV2ykQM",
      },
    };
  },
  computed: {
